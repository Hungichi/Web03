    ...
    return (
        <div className='container-detail' style={{ maxWidth: "75%", margin: "auto", height: "80vh", marginTop: "5%", background: "white", boxShadow: "5px 5px 10px 3px rgba(0,0,0,0.3)" }}>
            ...
            <div className='right' style={{ width: "50%", padding: "50px 100px 50px 50px", position: "absolute", top: "20px", left: "650px" }}>
                ...
                <div className='detail-quality' style={{ marginTop: "15px" }}>
                    ...
                    <form className='form-detail' style={{ display: "flex" }}>
                        <div className='qtyMinus' style={{ width: "34px", height: "34px", background: "#212529", textAlign: "center", fontSize: "19px", lineHeight: "36px", color: "#fff", cursor: "pointer", borderRadius: "3px 0 0 3px ", position: "absolute", top: "480px", left: "200px" }}>-</div>
                        <input type='text' name='quality' value="1" className='inp-detail' style={{ width: "60px", textAlign: "center", position: "absolute", top: "481px", left: "234px", height: "33px" }} />
                        <div className='qtyPlus' style={{ width: "34px", height: "34px", background: "#212529", textAlign: "center", fontSize: "19px", lineHeight: "36px", color: "#fff", cursor: "pointer", borderRadius: "0px 3px 3px 0px ", position: "absolute", top: "480px", left: "290px" }}>+</div>
                    </form>
                </div>
                <div class="addcart-area" style={{ display: "flex", marginTop: "45px", }}>
                    <button type="button" id="add-to-cart" class="addCard-button" name="add" style={{ background: "#000", border: "1px solid #000 ", color: "#fff", width: "50%", borderRadius: "4px", padding: "12px 20px", fontWeight: "600", fontSize: "15px" }} >
                        <span>Add to card</span>
                    </button>
                    <button type="button" id="buy-now" class="buy-button" name="add" style={{ marginLeft: "15px", background: "red", border: "1px solid red ", color: "#fff", width: "50%", borderRadius: "4px", padding: "12px 20px", fontWeight: "600", fontSize: "15px" }} >
                        <span>Buy</span>
                    </button>
